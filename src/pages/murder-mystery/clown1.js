      ...
      <div className="Clown1Page">
        <div>
          <ClownTitle>at the carnival</ClownTitle>
                ...
                <div className="text"><div>The mother, crying, starts to talk.</div> “We were with Judy all day. We first went to play cornhole, my kids favorite game. Then we went to the cotton candy booth. Her favorite color is blue so she got a blueberry flavored one. She also asked me for a blue ICEE so we bought her that too. After that we went to the elephant act. Elephants are her favorite animals. We got popcorn too, but she spilled it on the ground because one of the elephants' trumpet startled her.”</div>
                <Center><img className="judy2" src={'/judy2.png'} alt="judy2" />;</Center>
