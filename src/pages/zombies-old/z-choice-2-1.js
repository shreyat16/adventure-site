...
class ZChoice21Page extends React.Component {
  render() {
    return (
      <div className="zchoice21">
        <Message>
          You chose: Talk to him Hey dude! What are you doing with all that
        ...
        <Message>
          <h2>
            <Link to="/zombies/z-choice-2-1-1">Grab a ton of spinach</Link>
          </h2>
        </Message>
      </div>
    )
