  ...
  render() {
    return (
      <div className="zchoice2">
        <Message>
          You chose: Go to the store You get in your car and start backing up.
          ...
          are falling on his face. Strange… who needs that much spinach? Should
          you... Talk to him Ignore and move on
        </Message>
        <Message>
          <h2>
            <Link to="/zombies/z-choice-2-1">Talk to him Hey dude!</Link>
          </h2>
          <h2>
            <Link to="/zombies/z-choice-2-2">Ignore and move on</Link>
          </h2>
        </Message>
      </div>
    )
